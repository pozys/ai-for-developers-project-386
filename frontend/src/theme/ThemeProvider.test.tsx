...
interface MockMediaQueryList {
  ...
  removeEventListener: (eventName: 'change', listener: MatchMediaListener) => void
}
...
function createMatchMedia(matches: boolean) {
  ...
  const mediaQueryList: MockMediaQueryList = {
    addEventListener: vi.fn((eventName: 'change', listener: MatchMediaListener) => {
      if (eventName === 'change') {
    ...
    onchange: null,
    removeEventListener: vi.fn((eventName: 'change', listener: MatchMediaListener) => {
      if (eventName === 'change') {
...
describe('ThemeToggle', () => {
  it('switches theme from the app header', async () => {
    ...
    expect(screen.getByRole('button', { name: /Текущая тема: Тёмная/i })).toBeInTheDocument()
  ...
  it('renders the toggle in the layout', () => {
    ...
    expect(screen.getByRole('button', { name: /Текущая тема:/i })).toBeInTheDocument()
  })
})
