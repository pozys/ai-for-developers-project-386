...
function renderEditEventTypePage(initialEntries = ['/admin/event-types/evt-type-1/edit']) {
  return render(
...
describe('EditEventTypePage', () => {
  ...
  it('показывает ошибку 404 при сохранении', async () => {
    ...
    expect(await screen.findByText('Тип события не найден или уже был удалён')).toBeInTheDocument()
  })
})
